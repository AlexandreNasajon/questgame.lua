...
enemy = {
    ...
    {["name"] = "Lil Bear",["power"] = 2,["life"] = 5, ["gold"] = 5},
    {["name"] = "Serpent",["power"] = 3,["life"] = 4, ["gold"] = 2},
    {["name"] = "Slime",["power"] = 1,["life"] = 9, ["gold"] = 2},
    {["name"] = "Lil Wolf",["power"] = 2,["life"] = 7, ["gold"] = 3},
}
...
function printpack(p) -- problema aqui
    i = 1
    while i<=#p do
    print(p["pack"][i])
    i = i+1
...
function game()
    ...
    while Player["life"]>0 do
        ...
        elseif action == 3 then
            ...
            local valid = option>0 and option<5
            local notvalid = option<0 or option>4
        ...
        elseif action == 4 then
            ...
            if option == 1 then
                ...
                local random_enemy = enemy[math.random(1,5)]
                print("A wild "..random_enemy["name"].." appeared!")
                print("Name: "..random_enemy["name"],"Power: "..random_enemy["power"],"Life: "..random_enemy["life"],"Reward: "..random_enemy["gold"].." gold")
                print("What do?")
